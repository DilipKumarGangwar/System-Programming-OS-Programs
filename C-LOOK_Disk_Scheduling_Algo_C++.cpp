...
int applyCLOOKAlgo(int total_cylinders, vector<int> request_queue, int initial_pos, vector<int> &seek_sequence, int direction,int n)
{
	int total_head_movement=0;
...
int main()
{
    ...
    total_head_movement = applyCLOOKAlgo(total_cylinders, request_queue,initial_pos,seek_sequence,direction,n);
