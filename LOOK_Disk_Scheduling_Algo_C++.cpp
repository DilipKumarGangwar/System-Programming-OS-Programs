...
int applyLOOKAlgo(int total_cylinders, vector<int> request_queue, int initial_pos, vector<int> &seek_sequence, int direction,int n)
{
...
int main()
{
    ...
    total_head_movement = applyLOOKAlgo(total_cylinders, request_queue,initial_pos,seek_sequence,direction,n);
